...
- **التباين:** كل تركيبات النص فوق `ink-950`/`ink-900`/`ink-800` ≥ 4.5:1 بعد نقل نص `ink-400` إلى `ink-300`. حلقة التركيز: `brand-400/40` وحدها = **2.27:1** على `ink-950` (دون حد 3:1)، وبإضافة نواة صلبة `brand-400` = **7.27:1**.
