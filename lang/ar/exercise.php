...
return [
    ...
    'filters' => [
        'none_title' => 'وسّع بحثك قليلًا',
        'none_for' => 'لا يوجد تمرين مع :filter «:value». امسح هذا المرشّح أو غيّره.',
        'none_for_combination' => 'لا يوجد تمرين يجمع كل ما اخترته. امسح مرشّحًا واحدًا وجرّب مرة أخرى.',
    ],
    'empty' => [
